...
快来编写一个程序，按上述规则，制作一个 $N\\times N$ 的幻方吧。`,
    ...
    testCases: [
      ...
      { input: "21", output: "245 268 291 314 337 360 383 406 429 452 1 24 47 70 93 116 139 162 185 208 231\n267 290 313 336 359 382 405 428 451 21 23 46 69 92 115 138 161 184 207 230 244\n289 312 335 358 381 404 427 450 20 22 45 68 91 114 137 160 183 206 229 252 266\n311 334 357 380 403 426 449 19 42 44 67 90 113 136 159 182 205 228 251 265 288\n333 356 379 402 425 448 18 41 43 66 89 112 135 158 181 204 227 250 273 287 310\n355 378 401 424 447 17 40 63 65 88 111 134 157 180 203 226 249 272 286 309 332\n377 400 423 446 16 39 62 64 87 110 133 156 179 202 225 248 271 294 308 331 354\n399 422 445 15 38 61 83 86 109 132 155 178 201 224 247 270 293 307 330 353 376\n421 444 14 37 60 82 85 108 131 154 177 200 223 246 269 292 315 329 352 375 398\n443 13 36 59 81 84 107 130 153 176 199 222 245 268 291 314 328 351 374 397 420\n12 35 58 80 103 106 129 152 175 198 221 244 267 290 313 336 350 373 396 419 442\n34 57 79 102 104 128 151 174 197 220 243 266 289 312 335 349 372 395 418 441 11\n56 78 101 124 127 150 173 196 219 242 265 288 311 334 357 371 394 417 440 10 33\n77 100 123 126 149 172 195 218 241 264 287 310 333 356 370 393 416 439 9 32 55\n99 122 125 148 171 194 217 240 263 286 309 332 355 378 392 415 438 8 31 54 76\n121 144 147 170 193 216 239 262 285 308 331 354 377 391 414 437 7 30 53 75 98\n143 146 169 192 215 238 261 284 307 330 353 376 399 413 436 6 29 52 74 97 120\n165 168 191 214 237 260 283 306 329 352 375 398 412 435 5 28 51 73 96 119 142\n167 190 213 236 259 282 305 328 351 374 397 420 434 4 27 50 72 95 118 141 164\n189 212 235 258 281 304 327 350 373 396 419 433 3 26 49 71 94 117 140 163 186\n211 234 257 280 303 326 349 372 395 418 441 432 25 48 70 93 116 139 162 185 208" },
    ],
    timeLimit: 1000,
    memoryLimit: 512,
    hint: ``,
...
提示：不需要等到所有输入结束再依次输出，可以输入一个数就判断一个数并输出，再输入下一个数。`,
    ...
    testCases: [
      ...
      { input: "1\n8", output: "T" },               // 单位数8，变换后8是8的倍数
      { input: "1\n17", output: "T" },              // 两位数测试：1*7=7, 7->7, sum=7+7=14, 非8的倍数...需重新计算
      ...
      { input: "1\n888", output: "T" },             // 888: 8,8*7=56->5+6=11->1+1=2,8 -> 282 -> 2+8+2=12 非8倍数实际需验证
      { input: "1\n12345", output: "F" },           // 5位数测试
      { input: "1\n54321", output: "F" },           // 反向5位数
      { input: "1\n999999999999", output: "F" },    // 最大值边界10^12-1附近
      { input: "3\n1\n8\n16", output: "F\nT\nT" },  // 多个小数测试
      { input: "5\n100\n200\n300\n400\n500", output: "F\nF\nF\nF\nF" }, // 整百数批量
      { input: "1\n71", output: "T" },              // 71: 1*7=7, 7; 和=7+7=14非8倍数，需重算
      { input: "1\n62", output: "T" },              // 62: 2, 6*7=42->4+2=6; 和=2+6=8 是8倍数
    ],
    timeLimit: 1000,
    memoryLimit: 128,
    hint: ``,
...
你能通过编写程序，找到一个正整数的变长编码吗？`,
    ...
    testCases: [
      ...
      { input: "1000000000000000000", output: "80 80 A0 C8 DD CA F4 80 0E" }, // 10^18
    ],
    timeLimit: 1000,
    memoryLimit: 128,
    hint: ``,
...
接下来一行 $N$ 个用空格隔开的整数，依次为 $v_1,v_2,\\cdots,v_n$，表示田忌的马匹们的速度。保证 $1\\le v_i\\le 2N$。`,
    ...
    testCases: [
      ...
      { input: "4\n1 4 5 8\n2 3 6 7", output: "4" }, // 复杂分布
      { input: "2\n100000 1\n2 99999", output: "2" }, // 大数值
    ],
    timeLimit: 1000,
    memoryLimit: 512,
    hint: `**样例解释 1**
...
小杨想知道 Recamán 数列的前 $n$ 项从小到大排序后的结果。手动计算非常困难，小杨希望你能帮他解决这个问题。`,
    ...
    testCases: [
      ...
      { input: "7", output: "1 2 3 6 7 12 13" },      // a7=13-7? 检查
      { input: "10", output: "1 2 3 6 7 11 12 13 20 21" },
      { input: "15", output: "1 2 3 6 7 11 12 13 20 21 22 42 43 44 45" },
      { input: "20", output: "1 2 3 6 7 11 12 13 20 21 22 42 43 44 45 24 46 79 78 80" },
      { input: "25", output: "1 2 3 6 7 11 12 13 20 21 22 24 42 43 44 45 46 78 79 80 119 120 121 122 56" },
      { input: "30", output: "1 2 3 6 7 11 12 13 20 21 22 24 42 43 44 45 46 56 78 79 80 117 118 119 120 121 122 57 150 151" },
      { input: "50", output: "1 2 3 6 7 11 12 13 20 21 22 24 42 43 44 45 46 56 57 78 79 80 117 118 119 120 121 122 150 151 152 153 180 181 182 58 183 184 86 87 88 89 185 248 249 250 251 252 253 254 255" },
      { input: "100", output: "1 2 3 6 7 11 12 13 20 21 22 24 42 43 44 45 46 56 57 58 78 79 80 86 87 88 89 117 118 119 120 121 122 150 151 152 153 180 181 182 183 184 185 248 249 250 251 252 253 254 255 340 341 342 343 344 345 442 443 444 445 446 447 448 449 450 549 550 551 552 553 554 555 657 658 659 660 661 662 663 664 774 775 776 777 778 779 780 781 782 783 899 900 901 902 903 904 905 906 907 908 909" },
    ],
    timeLimit: 1000,
    memoryLimit: 512,
    hint: `#### 样例解释
...
之后 $n$ 行，每行包含一个字符串 $s_i$。`,
    ...
    testCases: [
      ...
      // 边界测试 - 字符必须单调不递减
      { input: "1\n1\na", output: "1" },              // 单个字符串a
      { input: "1\n1\nabc", output: "0" },            // 单个字符串非递增
      { input: "1\n1\naaa", output: "1" },            // 单个字符串全相同
      { input: "1\n2\na\nb", output: "1" },           // a+b=ab 递增
      { input: "1\n2\nb\na", output: "0" },           // ba 非递增
      { input: "1\n2\na\na", output: "1" },           // aa 相同
      { input: "1\n3\na\na\na", output: "1" },        // aaa
      { input: "1\n2\nab\nbc", output: "0" },         // ab+bc=abbc, b>b失败
      { input: "1\n2\naa\naa", output: "1" },         // aaaa
      { input: "1\n3\na\nab\nbb", output: "0" },      // a+ab+bb=aabbb? a<a, a<b, b=b, b=b 但ab末尾b>bb开头b不对
      { input: "1\n2\nabc\ncde", output: "0" },       // abc+cde, c=c可以但abc本身非递增
...
之后 $n$ 行，每行包含一个长度为 $m$ 且仅包含字符 \`.\` 和 \`#\` 的字符串。如果为 \`.\`，代表该位置为荒地；如果为 \`#\`，代表该位置为杂物。`,
    ...
    testCases: [
      ...
      { input: "1 1\n.", output: "1" },              // 单格荒地
      { input: "1 1\n#", output: "0" },              // 单格杂物
      { input: "1 3\n...", output: "1" },            // 1行3列，只有中间可开垦
      { input: "3 1\n.\n.\n.", output: "1" },        // 3行1列，只有中间可开垦
      { input: "3 3\n...\n...\n...", output: "1" },  // 3x3全荒地，只有中心可开垦
      { input: "3 3\n...\n.#.\n...", output: "0" },  // 中心有杂物
      { input: "3 3\n###\n###\n###", output: "0" },  // 全杂物
      { input: "5 5\n.....\n.....\n.....\n.....\n.....", output: "9" }, // 5x5内部3x3可开垦
      { input: "3 3\n.#.\n#.#\n.#.", output: "0" },  // 十字杂物
      { input: "3 5\n.....\n.....\n.....", output: "3" }, // 3行只有中间行可开垦
      { input: "5 3\n...\n...\n...\n...\n...", output: "3" }, // 5行3列
      { input: "4 4\n....\n.##.\n.##.\n....", output: "0" }, // 中间2x2杂物
...
数据保证总存在一个适合建造停机坪的区域。`,
    ...
    testCases: [
      ...
      { input: "3 3 0\n1 1 1\n1 2 1\n1 1 1", output: "0" },    // H=0无法满足(如果没有全相同区域)
