...
接下来 $T$ 行，每行若干用单个空格隔开的正整数。首先是两个正整数$N,M$，接着是 $M$ 个正整数 $a_0,a_1...a_{M-1}$。保证 $N \\le a_0+a_1+\\cdots+a_{M-1} \\le N+1 $。`,
    ...
    testCases: [
      ...
      // 组合数溢出测试
      { input: `1\n500 2 250 250`, output: `300258156` },
    ],
    timeLimit: 1000,
    memoryLimit: 512,
    hint: `**样例解释 1**
...
请注意，这个数可能很大，使用 C++ 语言的选手请酌情使用 \`long long\` 等数据类型存储答案。`,
    ...
    testCases: [
      ...
      // K>N*M，一些k无法满足
      { input: `2 2 10`, output: `21` },
      // N和M差距较大
      { input: `1 10 5`, output: `15` },
      { input: `10 1 5`, output: `15` },
      // 质数测试
      { input: `7 7 7`, output: `108` },
      // K=1，只统计(1,1)
      { input: `10 10 1`, output: `1` },
      // K=2
      { input: `5 5 2`, output: `9` },
      // 中等规模
      { input: `50 50 50`, output: `21478` },
      // N和M不相等
      { input: `30 20 25`, output: `5323` },
      // 较大K但N,M较小
      { input: `10 10 100`, output: `1153` },
    ],
    timeLimit: 1000,
    memoryLimit: 128,
    hint: `### 样例 1 解释
