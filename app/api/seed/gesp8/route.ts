...
对于所有测试数据点，保证 $1\\leq n\\leq 2\\times 10^5$，$0\\leq m\\leq 2\\times 10^5$。`,
  ...
  // ========== 2025年3月 ==========
  {
    ...
    difficulty: "普及/提高-",
    description: `对应的选择、判断题：https://ti.luogu.com.cn/problemset/1180
...
对于全部数据，保证有 $ 1 \\leq n \\leq 10^6 $, $ 0 \\leq a \\leq 10^5 $, $ u_i \\neq v_i $, $ b_u \\neq b_v $。`,
  ...
  // ========== 2025年6月 ==========
  {
    ...
    difficulty: "普及+/提高",
    description: `对应的选择、判断题：https://ti.luogu.com.cn/problemset/1188
...
async function seedGesp8() {
  try {
    ...
    const problemsWithTestCases = gesp8Problems.map(p => ({
      ...p,
      testCases: p.samples,
    }));
