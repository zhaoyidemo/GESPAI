...
接下来是 $t$ 组测试用例。对于每组测试用例，只有一行一个整数 $h$，代表怪物血量。`,
    ...
    testCases: [
      ...
      { input: "3\n100\n1000\n10000", output: "3\n3\n7" },  // 100=97+3(3次)，1000=997+3(3次)，10000=9937+63(7次)
...
给定正整数 $l,r$，请你求出 $l,l+1,\\ldots,r$ 之间所有有趣的整数之和。`,
    ...
    testCases: [
      ...
      { input: "100 200", output: "7649" },  // 列举验证：100,103,104,...共51个有趣数
